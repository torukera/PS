local SKILL_NAME = "Fly"
local INTERVAL = 2000
local PROJECTILE = getPokemonSkillProjectile(SKILL_NAME)

function onTargetCreature_Fly(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Fly")
