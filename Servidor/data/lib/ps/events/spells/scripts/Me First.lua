-- local SKILL_NAME = "Mimic"
--local DISABLED_MIMIC_MOVES = {"Metronome", "Sketch", "Struggle"}

function onTargetCreature_Mimic(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Mimic")
