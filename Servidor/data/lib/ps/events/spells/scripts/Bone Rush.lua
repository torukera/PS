...
function onTargetCreature_BoneRush(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_BoneRush")
