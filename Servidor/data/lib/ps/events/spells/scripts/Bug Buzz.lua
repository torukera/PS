...
for i, skillArea in ipairs(SKILL_AREAS) do
	...
	onTargetCreature_BugBuzz = function(cid, target)
	...
	setCombatCallback(combats[i], CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_BugBuzz")
