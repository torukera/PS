local SKILL_NAME = "Growl"
local SKILL_PROJECTILE = getPokemonSkillProjectile(SKILL_NAME)

function onTargetCreature_Growl(cid, target)
...
function onTargetTile_Growl(cid, position)
...
setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Growl")
setCombatCallback(combat, CALLBACK_PARAM_TARGETTILE, "onTargetTile_Growl")
