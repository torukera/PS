local SKILL_NAME = "Dragon Breath"
local LOOK_DIRS = {
...
function onTargetCreature_DragonBreath(cid, target)
...
setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_DragonBreath")
