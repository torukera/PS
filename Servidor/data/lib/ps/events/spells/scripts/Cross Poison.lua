local SKILL_NAME = "Cross Poison"
local SKILL_AREAS = {
	createCombatArea(AREA_CROSS2X2_DIAGONAL)
}

local combats = {}
for i, skillArea in ipairs(SKILL_AREAS) do
	combats[i] = createCombatObject()
	onTargetCreature_CrossPoison = function(cid, target)
	...
	setCombatCallback(combats[i], CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_CrossPoison")
