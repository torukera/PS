local SKILL_NAME = "Thunderbolt"

function onTargetCreature_Thunderbolt(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Thunderbolt")
