...
setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Uproar")
setCombatCallback(combat, CALLBACK_PARAM_TARGETTILE, "onTargetTile_Uproar")
