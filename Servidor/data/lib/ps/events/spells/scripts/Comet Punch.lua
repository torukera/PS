...
function onTargetCreature_CometPunch(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_CometPunch")
