...
for i, skillArea in ipairs(SKILL_AREAS) do
	...
	onTargetCreature_Hurricane = function(cid, target)
	...
	setCombatCallback(combats[i], CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Hurricane")
