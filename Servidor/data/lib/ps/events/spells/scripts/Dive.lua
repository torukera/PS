local SKILL_NAME = "Dive"
local INTERVAL = 2000

function onTargetCreature_Dive(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Dive")
