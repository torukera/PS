local SKILL_NAME = "Bounce"
local INTERVAL = 2000
local PROJECTILE = getPokemonSkillProjectile(SKILL_NAME)

function onTargetCreature_Bounce(cid, target)
...
local combat = createCombatObject() setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_Bounce")
