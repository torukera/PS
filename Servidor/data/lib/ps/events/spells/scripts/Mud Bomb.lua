local SKILL_NAME = "Mud Bomb"
local SKILL_PROJECTILE = getPokemonSkillProjectile(SKILL_NAME)

function onTargetCreature_MudBomb(cid, target)
...
function onTargetTile_MudBomb(cid, position)
...
setCombatCallback(combat, CALLBACK_PARAM_TARGETCREATURE, "onTargetCreature_MudBomb")
setCombatCallback(combat, CALLBACK_PARAM_TARGETTILE, "onTargetTile_MudBomb")
