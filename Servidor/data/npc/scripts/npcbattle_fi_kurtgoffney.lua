...
local npcBattle = NpcBattle:new(getNpcName(), 9208, 9608, npcHandler, 11032)
npcBattle:setPokemons({"Fearow", "Sandslash", "Persian", "Alakazam", "Dodrio", "Hypno"})
npcBattle:setDifficulty(63)
npcBattle:setRewardUniqueItems({18128, 1})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 25)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 2)
end)
