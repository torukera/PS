...
local npcBattle = NpcBattle:new(getNpcName(), 9222, 9622, npcHandler, 11002)
npcBattle:setPokemons({"Charizard", "Ninetales", "Arcanine", "Rapidash", "Typhlosion", "Magcargo"})
npcBattle:setDifficulty(65)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 35)
