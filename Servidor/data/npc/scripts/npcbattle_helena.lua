...
local npcBattle = NpcBattle:new(getNpcName(), 9134, 9520, npcHandler)
npcBattle:setPokemons({"Charmeleon", "Clefable", "Golbat", "Parasect", "Persian", "Golduck"})
npcBattle:setRewardBaseExp(40)
npcBattle:setRewardItems({14637, 1, 2152, 6})
