...
local npcBattle = NpcBattle:new(getNpcName(), 9244, 9644, npcHandler, 11030)
npcBattle:setPokemons({"Golem", "Dugtrio", "Steelix", "Parasect", "Vileplume", "Wigglytuff"})
npcBattle:setDifficulty(97)
npcBattle:setRewardUniqueItems({18128, 4})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 45)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 21)
end)
