...
local npcBattle = NpcBattle:new(getNpcName(), 9282, 9682, npcHandler)
npcBattle:setPokemons({"Ponyta", "Ekans", "Tauros", "Zubat"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(45)
npcBattle:setPokemonDefeatExperienced(true)
npcBattle:setRequiredStorage(9680)
npcBattle:setRewardUniqueItems({23542, 1})
