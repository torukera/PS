...
local npcBattle = NpcBattle:new(getNpcName(), 9250, 9650, npcHandler, 11035)
npcBattle:setPokemons({"Ariados", "Meganium", "Scizor", "Tangela", "Exeggutor", "Victreebel"})
npcBattle:setDifficulty(93)
npcBattle:setRewardUniqueItems({18128, 2})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 25)
