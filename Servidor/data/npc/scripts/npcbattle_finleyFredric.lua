...
local npcBattle = NpcBattle:new(getNpcName(), 9253, 9653, npcHandler)
npcBattle:setPokemons({"Venusaur", "Charizard", "Blastoise", "Pidgeot", "Raichu", "Crobat", "Vileplume",
    "Arcanine", "Alakazam", "Tentacruel"})
