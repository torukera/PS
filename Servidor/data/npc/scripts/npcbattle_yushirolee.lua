...
local npcBattle = NpcBattle:new(getNpcName(), 9124, 9548, npcHandler)
npcBattle:setPokemons({"Electabuzz", "Raichu", "Electrode", "Magneton", "Pikachu", "Electrode"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({5805, 1})
