...
local npcBattle = NpcBattle:new(getNpcName(), 9248, 9648, npcHandler, 11000)
npcBattle:setPokemons({"Blastoise", "Pidgeot", "Venusaur", "Meganium", "Feraligatr", "Azumarill"})
npcBattle:setDifficulty(91)
npcBattle:setRewardUniqueItems({18128, 1})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 15)
