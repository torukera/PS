...
local npcBattle = NpcBattle:new(getNpcName(), 9223, 9623, npcHandler, 11003)
npcBattle:setPokemons({"Donphan", "Piloswine", "Ursaring", "Shuckle", "Steelix", "Xatu"})
npcBattle:setDifficulty(75)
npcBattle:setRewardUniqueItems({18128, 5})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 105)
