...
local npcBattle = NpcBattle:new(getNpcName(), 9148, 9534, npcHandler)
npcBattle:setPokemons({"Alakazam", "Hypno", "Mr. Mime", "Slowbro", "Exeggutor", "Jynx"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_ZEN) end)
