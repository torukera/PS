...
local npcBattle = NpcBattle:new(getNpcName(), 9128, 9528, npcHandler)
npcBattle:setPokemons({"Bulbasaur", "Kangaskhan", "Bellsprout", "Shellder", "Snorlax", "Shiny Chansey"})
npcBattle:setRewardBaseExp(222)
npcBattle:setBaseBet(27)
