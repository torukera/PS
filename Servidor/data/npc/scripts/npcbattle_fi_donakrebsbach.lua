...
local npcBattle = NpcBattle:new(getNpcName(), 9219, 9619, npcHandler, 11013)
npcBattle:setPokemons({"Venusaur", "Butterfree", "Vileplume", "Venomoth", "Victreebel", "Exeggutor"})
npcBattle:setDifficulty(64)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 30)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 3)
end)
