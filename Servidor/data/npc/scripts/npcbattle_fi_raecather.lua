...
local npcBattle = NpcBattle:new(getNpcName(), 9251, 9651, npcHandler, 11045)
npcBattle:setPokemons({"Charizard", "Blastoise", "Venusaur", "Typhlosion", "Feraligatr", "Meganium"})
npcBattle:setDifficulty(100)
npcBattle:setRewardUniqueItems({18128, 6})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 60)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 23)
end)
