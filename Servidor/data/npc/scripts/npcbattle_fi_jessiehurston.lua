...
local npcBattle = NpcBattle:new(getNpcName(), 9210, 9610, npcHandler, 11026)
npcBattle:setPokemons({"Blastoise", "Dewgong", "Cloyster", "Jynx", "Lapras", "Piloswine"})
npcBattle:setDifficulty(66)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 40)
