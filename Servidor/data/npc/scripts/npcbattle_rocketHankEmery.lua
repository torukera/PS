...
local npcBattle = NpcBattle:new(getNpcName(), 9280, 9680, npcHandler)
npcBattle:setPokemons({"Vileplume", "Blastoise", "Poliwhirl", "Venomoth"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(45)
npcBattle:setPokemonDefeatExperienced(true)
npcBattle:setRequiredStorage(9681)
