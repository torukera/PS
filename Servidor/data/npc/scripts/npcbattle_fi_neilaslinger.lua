...
local npcBattle = NpcBattle:new(getNpcName(), 9243, 9643, npcHandler, 11043)
npcBattle:setPokemons({"Machamp", "Hitmontop", "Steelix", "Scizor", "Rhydon", "Marowak"})
npcBattle:setDifficulty(94)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 30)
