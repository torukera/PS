...
local npcBattle = NpcBattle:new(getNpcName(), 9229, 9629, npcHandler, 11037)
npcBattle:setPokemons({"Exeggutor", "Hypno", "Gengar", "Muk", "Victreebel", "Venomoth"})
npcBattle:setDifficulty(76)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 15)
