...
local npcBattle = NpcBattle:new(getNpcName(), 9137, 9546, npcHandler)
npcBattle:setPokemons({"Charizard", "Ninetales", "Primeape", "Machamp", "Victreebel", "Golem"})
npcBattle:setRewardBaseExp(85)
npcBattle:setRewardItems({14638, 1, 2152, 11})
npcBattle:setDifficulty(70)
npcBattle:setRequiredStorage(8052)
