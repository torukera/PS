...
local npcBattle = NpcBattle:new(getNpcName(), 9258, 9658, npcHandler)
npcBattle:setPokemons({"Feraligatr", "Noctowl", "Crobat", "Misdreavus", "Ursaring", "Magcargo", "Houndoom",
    "Hitmontop"})
npcBattle:setRewardBaseExp(5000)
npcBattle:setRewardUniqueItems({18284, 1})
npcBattle:setDifficulty(85)
npcBattle:setOneWin(true)
npcBattle:setRequired(function(cid) return getCreatureStorage(cid, 8258) == QUEST_STATUS.STARTED end)
