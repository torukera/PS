...
local npcBattle = NpcBattle:new(getNpcName(), 9228, 9628, npcHandler, 11011)
npcBattle:setPokemons({"Azumarill", "Politoed", "Sneasel", "Piloswine", "Jynx", "Dewgong"})
npcBattle:setDifficulty(86)
npcBattle:setRewardUniqueItems({18128, 4})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 65)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 17)
end)
