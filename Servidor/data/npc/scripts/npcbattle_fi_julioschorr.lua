...
local npcBattle = NpcBattle:new(getNpcName(), 9241, 9641, npcHandler, 11027)
npcBattle:setPokemons({"Golem", "Steelix", "Marowak", "Dugtrio", "Parasect", "Nidoking"})
npcBattle:setDifficulty(90)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 10)
