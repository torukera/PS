...
local npcBattle = NpcBattle:new(getNpcName(), 9119, 9515, npcHandler)
npcBattle:setPokemons({"Charizard", "Magmar", "Charmeleon", "Flareon", "Arcanine", "Rapidash"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({13813, 1})
