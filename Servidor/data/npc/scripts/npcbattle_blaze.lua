...
local npcBattle = NpcBattle:new("Blaze", 9112, 9505, npcHandler)
npcBattle:setPokemons({"Bulbasaur", "Ponyta", "Gastly", "Pikachu", "Bellsprout", "Rattata"})
npcBattle:setRewardBaseExp(18)
