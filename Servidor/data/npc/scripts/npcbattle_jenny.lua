...
local npcBattle = NpcBattle:new(getNpcName(), 9121, 9523, npcHandler)
npcBattle:setPokemons({"Onix", "Golem", "Rhyhorn", "Machamp", "Primeape", "Poliwrath"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({13815, 1})
