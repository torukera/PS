...
local npcBattle = NpcBattle:new(getNpcName(), 9254, 9654, npcHandler)
npcBattle:setPokemons({"Golem", "Magneton", "Gengar", "Hypno", "Raichu", "Crobat", "Vileplume",
    "Meganium", "Lapras", "Mr. Mime"})
