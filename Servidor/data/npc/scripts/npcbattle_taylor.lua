...
local npcBattle = NpcBattle:new(getNpcName(), 9136, 9544, npcHandler)
npcBattle:setPokemons({"Venusaur", "Pidgeot", "Arbok", "Fearow", "Nidoqueen", "Nidoking"})
npcBattle:setRewardBaseExp(74)
npcBattle:setRewardItems({14638, 1, 2152, 10})
