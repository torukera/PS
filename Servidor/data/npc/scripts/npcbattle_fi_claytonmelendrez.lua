...
local npcBattle = NpcBattle:new(getNpcName(), 9207, 9607, npcHandler, 11007)
npcBattle:setPokemons({"Sandslash", "Nidoqueen", "Nidoking", "Dugtrio", "Golem", "Onix"})
npcBattle:setDifficulty(60)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 10)
