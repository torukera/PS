...
local npcBattle = NpcBattle:new(getNpcName(), 9215, 9615, npcHandler, 11014)
npcBattle:setPokemons({"Dewgong", "Cloyster", "Jynx", "Lapras", "Sneasel", "Piloswine"})
npcBattle:setDifficulty(74)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 80)
