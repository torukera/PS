...
local npcBattle = NpcBattle:new(getNpcName(), 9143, 9541, npcHandler)
npcBattle:setPokemons({"Gengar", "Beedrill", "Arbok", "Nidoqueen", "Weezing", "Muk"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_SPECTRUM) end)
