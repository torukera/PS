...
local npcBattle = NpcBattle:new(getNpcName(), 9224, 9624, npcHandler, 11040)
npcBattle:setPokemons({"Dugtrio", "Golem", "Onix", "Marowak", "Rhydon", "Kangaskhan"})
npcBattle:setDifficulty(70)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 60)
