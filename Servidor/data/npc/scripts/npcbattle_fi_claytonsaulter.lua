...
local npcBattle = NpcBattle:new(getNpcName(), 9230, 9630, npcHandler, 11008)
npcBattle:setPokemons({"Piloswine", "Golem", "Scizor", "Forretress", "Sudowoodo", "Tauros"})
npcBattle:setDifficulty(88)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 75)
