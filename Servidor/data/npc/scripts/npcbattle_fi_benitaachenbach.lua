...
local npcBattle = NpcBattle:new(getNpcName(), 9235, 9635, npcHandler, 11005)
npcBattle:setPokemons({"Sandslash", "Dugtrio", "Golem", "Steelix", "Marowak", "Rhydon"})
npcBattle:setDifficulty(77)
npcBattle:setRewardUniqueItems({18128, 1, 12248, 3})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 20)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 12)
end)
