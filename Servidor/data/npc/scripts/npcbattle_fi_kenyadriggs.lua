...
local npcBattle = NpcBattle:new(getNpcName(), 9237, 9637, npcHandler, 11029)
npcBattle:setPokemons({"Parasect", "Bellossom", "Beedrill", "Butterfree", "Meganium", "Ariados"})
npcBattle:setDifficulty(79)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 30)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 13)
end)
