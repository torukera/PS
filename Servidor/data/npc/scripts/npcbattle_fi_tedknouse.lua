...
local npcBattle = NpcBattle:new(getNpcName(), 9242, 9642, npcHandler, 11047)
npcBattle:setPokemons({"Tentacruel", "Blastoise", "Dewgong", "Jynx", "Poliwrath", "Cloyster"})
npcBattle:setDifficulty(95)
npcBattle:setRewardUniqueItems({18128, 3})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 35)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 20)
end)
