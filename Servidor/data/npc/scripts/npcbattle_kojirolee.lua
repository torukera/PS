...
local npcBattle = NpcBattle:new(getNpcName(), 9123, 9530, npcHandler)
npcBattle:setPokemons({"Charizard", "Magmar", "Rapidash", "Ninetales", "Arcanine", "Flareon"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({5806, 1})
