...
local npcBattle = NpcBattle:new(getNpcName(), 9144, 9511, npcHandler)
npcBattle:setPokemons({"Tauros", "Clefable", "Wigglytuff", "Snorlax", "Machamp", "Hitmonlee"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_VITAL) end)
