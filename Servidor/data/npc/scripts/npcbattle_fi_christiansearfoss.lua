...
local npcBattle = NpcBattle:new(getNpcName(), 9226, 9626, npcHandler, 11006)
npcBattle:setPokemons({"Rhydon", "Marowak", "Steelix", "Exeggutor", "Dodrio", "Golem"})
npcBattle:setDifficulty(81)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 40)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 14)
end)
