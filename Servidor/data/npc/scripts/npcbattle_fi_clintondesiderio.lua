...
local npcBattle = NpcBattle:new(getNpcName(), 9213, 9613, npcHandler, 11010)
npcBattle:setPokemons({"Ursaring", "Hitmontop", "Miltank", "Furret", "Tauros", "Kangaskhan"})
npcBattle:setDifficulty(72)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 70)
