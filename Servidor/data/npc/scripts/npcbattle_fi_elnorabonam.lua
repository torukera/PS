...
local npcBattle = NpcBattle:new(getNpcName(), 9233, 9633, npcHandler, 11015)
npcBattle:setPokemons({"Persian", "Espeon", "Alakazam", "Hypno", "Exeggutor", "Gengar"})
npcBattle:setDifficulty(87)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 70)
