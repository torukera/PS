...
local npcBattle = NpcBattle:new(getNpcName(), 9238, 9638, npcHandler, 11034)
npcBattle:setPokemons({"Feraligatr", "Azumarill", "Quagsire", "Piloswine", "Jynx", "Dewgong"})
npcBattle:setDifficulty(78)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 25)
