...
local npcBattle = NpcBattle:new(getNpcName(), 9255, 9655, npcHandler)
npcBattle:setPokemons({"Typhlosion", "Magneton", "Vaporeon", "Hypno", "Starmie", "Crobat", "Kangaskhan",
    "Meganium", "Slowbro", "Mr. Mime", "Machamp", "Chansey"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(86)
npcBattle:setRequired(function(cid) return getCreatureStorage(cid, 8205) == QUEST_STATUS.STARTED end)
