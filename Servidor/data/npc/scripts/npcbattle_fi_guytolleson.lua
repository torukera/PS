...
local npcBattle = NpcBattle:new(getNpcName(), 9246, 9646, npcHandler, 11020)
npcBattle:setPokemons({"Victreebel", "Weezing", "Muk", "Venomoth", "Nidoqueen", "Nidoking"})
npcBattle:setDifficulty(96)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 40)
