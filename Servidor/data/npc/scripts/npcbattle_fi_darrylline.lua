...
local npcBattle = NpcBattle:new(getNpcName(), 9211, 9611, npcHandler, 11012)
npcBattle:setPokemons({"Blissey", "Mr. Mime", "Snorlax", "Espeon", "Girafarig", "Granbull"})
npcBattle:setDifficulty(71)
npcBattle:setRewardUniqueItems({18128, 3})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 65)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 6)
end)
