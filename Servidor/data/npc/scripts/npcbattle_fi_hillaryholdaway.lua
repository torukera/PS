...
local npcBattle = NpcBattle:new(getNpcName(), 9220, 9620, npcHandler, 11022)
npcBattle:setPokemons({"Raichu", "Sandslash", "Nidoqueen", "Clefable", "Dugtrio", "Dodrio"})
npcBattle:setDifficulty(75)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 95)
