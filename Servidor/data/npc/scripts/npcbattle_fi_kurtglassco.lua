...
local npcBattle = NpcBattle:new(getNpcName(), 9209, 9609, npcHandler, 11031)
npcBattle:setPokemons({"Houndoom", "Magcargo", "Steelix", "Typhlosion", "Magmar", "Rapidash"})
npcBattle:setDifficulty(75)
npcBattle:setRewardUniqueItems({18128, 4})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 85)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 8)
end)
