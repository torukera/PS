...
local npcBattle = NpcBattle:new(getNpcName(), 9227, 9627, npcHandler, 11009)
npcBattle:setPokemons({"Venomoth", "Scizor", "Exeggutor", "Tangela", "Pinsir", "Ariados"})
npcBattle:setDifficulty(84)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 55)
