...
local npcBattle = NpcBattle:new(getNpcName(), 9231, 9631, npcHandler, 11028)
npcBattle:setPokemons({"Victreebel", "Parasect", "Vileplume", "Crobat", "Nidoqueen", "Nidoking"})
npcBattle:setDifficulty(83)
npcBattle:setRewardUniqueItems({18128, 3})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 50)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 15)
end)
