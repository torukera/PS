...
local npcBattle = NpcBattle:new(getNpcName(), 9232, 9632, npcHandler, 11042)
npcBattle:setPokemons({"Sudowoodo", "Piloswine", "Steelix", "Magcargo", "Donphan", "Omastar"})
npcBattle:setDifficulty(80)
npcBattle:setRewardUniqueItems({18128, 2})
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_FIFTEEN, 35)
