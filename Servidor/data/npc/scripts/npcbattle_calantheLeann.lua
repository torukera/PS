...
local npcBattle = NpcBattle:new(getNpcName(), 9256, 9656, npcHandler)
npcBattle:setPokemons({"Typhlosion", "Primeape", "Vaporeon", "Hypno", "Starmie", "Wigglytuff", "Kangaskhan",
    "Meganium", "Slowbro", "Nidoking", "Butterfree", "Chansey", "Ampharos"})
