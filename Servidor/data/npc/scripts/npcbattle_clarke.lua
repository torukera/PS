...
local npcBattle = NpcBattle:new(getNpcName(), 9113, 9512, npcHandler)
npcBattle:setPokemons({"Gastly", "Drowzee", "Abra", "Horsea", "Slowpoke", "Paras"})
npcBattle:setRewardBaseExp(25)
