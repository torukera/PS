...
local npcBattle = NpcBattle:new(getNpcName(), 9247, 9647, npcHandler, 11001)
npcBattle:setPokemons({"Parasect", "Venomoth", "Vileplume", "Tauros", "Politoed", "Sudowoodo"})
npcBattle:setDifficulty(98)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 50)
