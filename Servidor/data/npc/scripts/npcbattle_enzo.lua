...
local npcBattle = NpcBattle:new(getNpcName(), 9145, 9517, npcHandler)
npcBattle:setPokemons({"Venusaur", "Parasect", "Victreebel", "Exeggutor", "Tangela", "Scyther"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_GAIA) end)
