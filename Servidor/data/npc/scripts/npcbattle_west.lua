...
local npcBattle = NpcBattle:new(getNpcName(), 9142, 9547, npcHandler)
npcBattle:setPokemons({"Raichu", "Magneton", "Electrode", "Electabuzz", "Jolteon", "Raichu"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_VOLTAGIC) end)
