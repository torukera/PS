...
local npcBattle = NpcBattle:new(getNpcName(), 9218, 9618, npcHandler, 11046)
npcBattle:setPokemons({"Dewgong", "Cloyster", "Slowbro", "Poliwrath", "Golduck", "Blastoise"})
npcBattle:setDifficulty(75)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 90)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 9)
end)
