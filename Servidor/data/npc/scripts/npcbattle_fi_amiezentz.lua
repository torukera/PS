...
local npcBattle = NpcBattle:new(getNpcName(), 9249, 9649, npcHandler, 11004)
npcBattle:setPokemons({"Jumpluff", "Bellossom", "Xatu", "Noctowl", "Ariados", "Ledian"})
npcBattle:setDifficulty(92)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TEN, 20)
