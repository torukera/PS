...
local npcBattle = NpcBattle:new(getNpcName(), 9146, 9509, npcHandler)
npcBattle:setPokemons({"Blastoise", "Golduck", "Poliwrath", "Dewgong", "Cloyster", "Lapras"})
npcBattle:setOneWin(true)
npcBattle:setDifficulty(85)
npcBattle:setRequired(function(cid) return not getPlayerMastery(cid) and getPlayerMasteryStonesPayed(cid, MASTERYID_AVALANCHE) end)
