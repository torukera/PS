...
local npcBattle = NpcBattle:new(getNpcName(), 9122, 9545, npcHandler)
npcBattle:setPokemons({"Poliwrath", "Gyarados", "Golduck", "Seaking", "Blastoise", "Seadra"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({5807, 1})
