...
local npcBattle = NpcBattle:new(getNpcName(), 9118, 9503, npcHandler)
npcBattle:setPokemons({"Hypno", "Gengar", "Alakazam", "Kadabra", "Haunter", "Gengar"})
npcBattle:setRewardBaseExp(10000)
npcBattle:setRewardItems({13812, 1})
