...
local npcBattle = NpcBattle:new(getNpcName(), 9217, 9617, npcHandler, 11016)
npcBattle:setPokemons({"Forretress", "Arbok", "Sandslash", "Nidoqueen", "Nidoking", "Parasect"})
npcBattle:setDifficulty(62)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 20)
