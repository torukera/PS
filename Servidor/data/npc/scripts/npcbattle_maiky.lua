...
local npcBattle = NpcBattle:new(getNpcName(), 9138, 9535, npcHandler)
npcBattle:setPokemons({"Blastoise", "Wigglytuff", "Rapidash", "Magneton", "Gengar", "Alakazam"})
npcBattle:setRewardBaseExp(80)
npcBattle:setRewardItems({14638, 1, 2152, 12})
