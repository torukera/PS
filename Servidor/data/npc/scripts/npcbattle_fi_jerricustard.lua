...
local npcBattle = NpcBattle:new(getNpcName(), 9216, 9616, npcHandler, 11025)
npcBattle:setPokemons({"Golem", "Onix", "Rhydon", "Omastar", "Sudowoodo", "Shuckle"})
npcBattle:setDifficulty(61)
npcBattle:setOnWin(function(cid)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.BATTLE_TOWER_TWENTY, 15)
    doPlayerAddHighscoreValue(cid, HIGHSCORE_IDS.FRONTIER_ISLAND, 1)
end)
