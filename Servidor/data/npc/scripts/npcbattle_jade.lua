...
local npcBattle = NpcBattle:new(getNpcName(), 9127, 9522, npcHandler)
npcBattle:setPokemons({"Abra", "Drowzee", "Jigglypuff", "Venonat", "Psyduck", "Slowpoke"})
npcBattle:setRewardBaseExp(148)
