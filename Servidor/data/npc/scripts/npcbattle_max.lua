...
local npcBattle = NpcBattle:new(getNpcName(), 9132, 9536, npcHandler)
npcBattle:setPokemons({"Venonat", "Meowth", "Psyduck", "Mankey", "Growlithe", "Poliwag"})
npcBattle:setRewardBaseExp(23)
npcBattle:setRewardItems({14636, 1, 2152, 3})
npcBattle:setDifficulty(30)
