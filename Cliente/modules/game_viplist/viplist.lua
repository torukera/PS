...
function init()
  ...
  vipWindow:getChildById('icon'):setImageSource('/images/topbuttons/viplist')
end
...
local function doUpdateStatusCount()
  ...
  vipWindow:getChildById('text'):setText(tr('Online') .. " [" .. onlineCount .. "/" .. onlineCount + offlineCount .. "]")
end
