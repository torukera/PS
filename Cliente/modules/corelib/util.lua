...
-- function onHealthChange(player, health, maxHealth)
  -- createTexturedBar('healthBar', health, maxHealth, 90, 33, rootPanel, 3, 1)
-- end
...
-- panel = target panel in our module.
-- step = how many bars is on our texture, if used with single bar per texture you don't need to declare it.
-- pos = position of bar, no need to declare if used with single bar per texture.
