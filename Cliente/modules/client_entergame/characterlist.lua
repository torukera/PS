    ...
    for key,value in pairs(characterInfo) do
      ...
      elseif key == 'pokemonTeam' then
        for k, v in pairs(value) do
          ...
          if (subWidget) then
            subWidget:setImageSource('/images/pokemon_image/' .. getPokemonNameByNumber(v.number))
...
function CharacterList.show()
  ...
  if loadBox or errorBox or not charactersWindow or createChar:isVisible() or createAcc:isVisible() then return end
