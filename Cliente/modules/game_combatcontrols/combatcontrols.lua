...
function init()
    ...
    combatControlsWindow:getChildById('icon'):setImageSource('/images/topbuttons/combatcontrols')
    combatControlsWindow:getChildById('text'):setText(tr'Combat Controls')
end
