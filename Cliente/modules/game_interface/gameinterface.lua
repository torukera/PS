...
function init()
  ...
  PokeWindow = g_ui.displayUI('drop_pokewindow')
  hidePokeWindow()
  Bagwindow = g_ui.displayUI('drop_bagwindow')
  hideBagWindow()
  ForceExitwindow = g_ui.displayUI('ui/ForceExit')
  hideForceExitwindow()
  Exitwindow = g_ui.displayUI('ui/Exit')
  hideExitwindow()
end
...
function hideForceExitwindow()
  ForceExitwindow:hide()
  return true
end
function hidePokeWindow()
  PokeWindow:hide()
  return true
end
function hideBagWindow()
  Bagwindow:hide()
  return true
end

function showPokeWindow(item, pos)
  hideBagWindow()
  hideForceExitwindow()
  hideExitwindow()
  ...
  PokeWindow:raise()
  PokeWindow:focus()
  PokeWindow.onEnter = function() g_game.move(item, pos, 1) hidePokeWindow() end
  PokeWindow:getChildById('yesButton').onClick = function() g_game.move(item, pos, 1) hidePokeWindow() end
  return true
end
function showBagWindow(item, pos)
  hidePokeWindow()
  hideForceExitwindow()
  hideExitwindow()
  ...
  Bagwindow:raise()
  Bagwindow:focus()
  Bagwindow.onEnter = function() g_game.move(item, pos, 1) hideBagWindow() end
  Bagwindow:getChildById('yesButton').onClick = function() g_game.move(item, pos, 1) hideBagWindow() end
  return true
end
...
local ExitWindow = function()
  hideBagWindow()
  hidePokeWindow()
  hideExitwindow()

  ForceExitwindow:show()
  ForceExitwindow:getChildById("yesButton").onClick = function() exitFunc() end
end
  ExitWindow()
  return true
end
...
local yesCallback = function() g_game.safeLogout()
  Exitwindow:hide()
  modules.game_bottommenu.hide()
end
local ExitWindow = function()
  ...
  Exitwindow:show()
  Exitwindow:getChildById("yesButton").onClick = function() yesCallback() end
end
  ExitWindow()
end
...
function createThingMenu(menuPosition, lookThing, useThing, creatureThing)
  ...
  if lookThing then
    if lookThing:getId() == 3497 or lookThing:getId() == 3498 or lookThing:getId() == 3499 or lookThing:getId() == 3500 or lookThing:getId() == 24769 or lookThing:getId() == 24770 or lookThing:getId() == 24768 or lookThing:getId() == 33870 or lookThing:getId() == 33871 or lookThing:getId() == 33872 or lookThing:getId() == 33873 or lookThing:getId() == 33874 or lookThing:getId() == 33875 or lookThing:getId() == 33876 or lookThing:getId() == 33877 or lookThing:getId() == 33878 or lookThing:getId() == 33879 or lookThing:getId() == 33880 or lookThing:getId() == 33881 or lookThing:getId() == 33882 or lookThing:getId() == 33883 or lookThing:getId() == 33884 or lookThing:getId() == 33885 or lookThing:getId() == 33886 or lookThing:getId() == 33887 or lookThing:getId() == 33888 or lookThing:getId() == 33889 or lookThing:getId() == 33890 or lookThing:getId() == 33891 or lookThing:getId() == 33892 or lookThing:getId() == 33893 or lookThing:getId() == 33894 or lookThing:getId() == 33895 or lookThing:getId() == 33896 or lookThing:getId() == 33897 or lookThing:getId() == 33898 or lookThing:getId() == 33899 or lookThing:getId() == 33900 or lookThing:getId() == 33901 or lookThing:getId() == 33902 or lookThing:getId() == 33903 or lookThing:getId() == 33904 or lookThing:getId() == 33905 or lookThing:getId() == 33906 or lookThing:getId() == 33907 or lookThing:getId() == 33908 or lookThing:getId() == 33909 or lookThing:getId() == 33910 or lookThing:getId() == 33911 or lookThing:getId() == 33912 or lookThing:getId() == 33913 or lookThing:getId() == 33914 or lookThing:getId() == 33915 or lookThing:getId() == 33916 or lookThing:getId() == 33917 or lookThing:getId() == 33918 or lookThing:getId() == 33919 or lookThing:getId() == 33920 or lookThing:getId() == 33921 or lookThing:getId() == 33922 or lookThing:getId() == 33923 or lookThing:getId() == 33924 or lookThing:getId() == 33925 or lookThing:getId() == 33926 or lookThing:getId() == 33927 or lookThing:getId() == 33928 or lookThing:getId() == 33929 or lookThing:getId() == 33930 or lookThing:getId() == 33931 or lookThing:getId() == 33932 or lookThing:getId() == 33933 or lookThing:getId() == 33934 or lookThing:getId() == 33935 or lookThing:getId() == 33936 or lookThing:getId() == 33937 or lookThing:getId() == 33938 or lookThing:getId() == 33939 or lookThing:getId() == 33940 or lookThing:getId() == 33941 or lookThing:getId() == 33942 or lookThing:getId() == 33943 or lookThing:getId() == 33944 or lookThing:getId() == 33945 or 
	lookThing:getId() == 33946 or 

	lookThing:getId() == 24793 then

      menu:addOption(tr('Configurações'), function() g_game.talk("/dpconfig ") end)
      menu:addSeparator()
      menu:addOption(tr('Termos de responsabilidade'), function() modules.game_depotlock.showTerms() end)
    end
  end
  ...
  if creatureThing then
    ...
    if creatureThing:isLocalPlayer() then
      ...
      if (creatureThing:isLocalPlayerSummon()) then
        menu:addOption(tr('Evolve'), function() g_game.talkChannel(MessageModes.Say, 0, '/evolve') end)
      end
...
function moveStackableItem(item, toPos)
  ...
  g_keyboard.bindKeyPress("Up", function() check() spinbox:setValue(spinbox:getValue()+1) end, spinbox)
  g_keyboard.bindKeyPress("Down", function() check() spinbox:setValue(spinbox:getValue()-1) end, spinbox)
  g_keyboard.bindKeyPress("Right", function() check() spinbox:setValue(spinbox:getValue()+1) end, spinbox)
  g_keyboard.bindKeyPress("Left", function() check() spinbox:setValue(spinbox:getValue()-1) end, spinbox)
