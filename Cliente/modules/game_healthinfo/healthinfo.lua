...
function init()
  ...
  pokemonExperienceBar = healthInfoWindow:recursiveGetChildById('pokemonExperienceBar')
...
function onPokemonLevelChange(localPlayer, value, percent)
    pokemonExperienceBar:setText(percent .. '%')
    pokemonExperienceBar:setTooltip(tr(pokemonExperienceTooltip, percent, value+1))
    pokemonExperienceBar:setPercent(percent)
end

function onSoulChange(localPlayer, soul)
  soulLabel:setText(tr('Respect') .. ': ' .. soul)
end

function onFreeCapacityChange(player, freeCapacity)
  capLabel:setText(tr('Balls') .. ': ' .. math.floor(freeCapacity))
end
